...
static void test_reset_search_binding_uses_c_runtime(void);
static void test_reset_search_action_uses_c_runtime(void);
...
static void
test_reset_search_binding_uses_c_runtime(void) {
...
static void
test_reset_search_action_uses_c_runtime(void) {
    test_state_reset();
...
main(void) {
    ...
    test_reset_search_binding_uses_c_runtime();
    test_reset_search_action_uses_c_runtime();
    exit(EXIT_SUCCESS);
}
