...
APPLY_BOOL(apply_discard_colors_if_item_is_selected, discard_colors_if_item_is_selected)
...
APPLY_BOOL(apply_media_library_albums_split_by_date, media_library_albums_split_by_date)
APPLY_STRING(apply_default_tag_editor_pattern, default_tag_editor_pattern)
...
APPLY_BOOL(apply_fetch_lyrics_for_current_song_in_background, fetch_lyrics_in_background)
APPLY_BOOL(apply_store_lyrics_in_song_dir, store_lyrics_in_song_dir)
APPLY_BOOL(apply_generate_win32_compatible_filenames, generate_win32_compatible_filenames)
APPLY_BOOL(apply_allow_for_physical_item_deletion, allow_for_physical_item_deletion)
APPLY_STRING(apply_lastfm_preferred_language, lastfm_preferred_language)
APPLY_BOOL(apply_show_hidden_files_in_local_browser, local_browser_show_hidden_files)
APPLY_BOOL(apply_startup_slave_screen_focus, startup_slave_screen_focus)
APPLY_BOOL(apply_ask_for_locked_screen_width_part, ask_for_locked_screen_width_part)
APPLY_BOOL(apply_jump_to_now_playing_song_at_start, jump_to_now_playing_song_at_start)
...
APPLY_BOOL(apply_block_search_constraints_change_if_items_found, block_search_constraints_change)
