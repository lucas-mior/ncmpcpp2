...
#define OPT_ADD(NAME, DEFAULT_VALUE, APPLY)              \
    {                                                            \
        .name = (char *)#NAME,                                    \
...
OPT_ADD(ncmpcpp_directory, "~/.config/ncmpcpp/", apply_ncmpcpp_directory),
OPT_ADD(lyrics_directory, "~/.lyrics/", apply_lyrics_directory),
OPT_ADD(mpd_host, "localhost", apply_mpd_host),
OPT_ADD(mpd_port, "6600", apply_mpd_port),
OPT_ADD(mpd_password, "", apply_mpd_password),
OPT_ADD(mpd_music_dir, "~/music", apply_mpd_music_dir),
OPT_ADD(mpd_connection_timeout, "5", apply_mpd_connection_timeout),
OPT_ADD(mpd_crossfade_time, "5", apply_mpd_crossfade_time),
OPT_ADD(random_exclude_pattern, "", apply_random_exclude_pattern),
OPT_ADD(visualizer_data_source, "/tmp/mpd.fifo",
                    apply_visualizer_data_source),
OPT_ADD(visualizer_output_name, "Visualizer feed",
                    apply_visualizer_output_name),
OPT_ADD(visualizer_in_stereo, "yes", apply_visualizer_in_stereo),
#if defined(HAVE_FFTW3_H)
OPT_ADD(visualizer_type, "spectrum", apply_visualizer_type),
#else
OPT_ADD(visualizer_type, "ellipse", apply_visualizer_type),
#endif
OPT_ADD(visualizer_look, "●▮", apply_visualizer_look),
OPT_ADD(visualizer_fps, "60", apply_visualizer_fps),
OPT_ADD(visualizer_autoscale, "no", apply_visualizer_autoscale),
OPT_ADD(visualizer_spectrum_smooth_look, "yes",
                    apply_visualizer_spectrum_smooth_look),
OPT_ADD(visualizer_spectrum_smooth_look_legacy_chars, "yes",
                    apply_visualizer_spectrum_smooth_look_legacy_chars),
OPT_ADD(visualizer_spectrum_dft_size, "2", apply_visualizer_spectrum_dft_size),
OPT_ADD(visualizer_spectrum_gain, "10", apply_visualizer_spectrum_gain),
OPT_ADD(visualizer_spectrum_hz_min, "20", apply_visualizer_spectrum_hz_min),
OPT_ADD(visualizer_spectrum_hz_max, "20000", apply_visualizer_spectrum_hz_max),
OPT_ADD(visualizer_spectrum_log_scale_x, "yes",
                    apply_visualizer_spectrum_log_scale_x),
OPT_ADD(visualizer_spectrum_log_scale_y, "yes",
                    apply_visualizer_spectrum_log_scale_y),
OPT_ADD(visualizer_color,
                    "blue, cyan, green, yellow, magenta, red",
                    apply_visualizer_color),
OPT_ADD(system_encoding, "", apply_system_encoding),
OPT_ADD(playlist_disable_highlight_delay, "5",
                    apply_playlist_disable_highlight_delay),
OPT_ADD(message_delay_time, "5", apply_message_delay_time),
OPT_ADD(song_list_format, "{%a - }{%t}|{$8%f$9}$R{$3%l$9}",
                    apply_song_list_format),
OPT_ADD(song_status_format,
                    "{{%a{ \"%b\"{ (%y)}} - }{%t}}|{%f}",
                    apply_song_status_format),
OPT_ADD(song_library_format, "{%n - }{%t}|{%f}",
                    apply_song_library_format),
OPT_ADD(alternative_header_first_line_format,
                    "$b$1$aqqu$/a$9 {%t}|{%f} $1$atqq$/a$9$/b",
                    apply_header_first_line_format),
OPT_ADD(alternative_header_second_line_format,
                    "{{$4$b%a$/b$9}{ - $7%b$9}{ ($4%y$9)}}|{%D}",
                    apply_header_second_line_format),
OPT_ADD(current_item_prefix, "$(yellow)$r",
                    apply_current_item_prefix),
OPT_ADD(current_item_suffix, "$/r$(end)",
                    apply_current_item_suffix),
OPT_ADD(current_item_inactive_column_prefix, "$(white)$r",
                    apply_current_item_inactive_column_prefix),
OPT_ADD(current_item_inactive_column_suffix, "$/r$(end)",
                    apply_current_item_inactive_column_suffix),
OPT_ADD(now_playing_prefix, "$b", apply_now_playing_prefix),
OPT_ADD(now_playing_suffix, "$/b", apply_now_playing_suffix),
OPT_ADD(browser_playlist_prefix, "$2playlist$9 ",
                    apply_browser_playlist_prefix),
OPT_ADD(selected_item_prefix, "$6",
                    apply_selected_item_prefix),
OPT_ADD(selected_item_suffix, "$9",
                    apply_selected_item_suffix),
OPT_ADD(modified_item_prefix, "$3>$9 ",
                    apply_modified_item_prefix),
OPT_ADD(song_window_title_format, "{%a - }{%t}|{%f}",
                    apply_song_window_title_format),
OPT_ADD(browser_sort_mode, "type", apply_browser_sort_mode),
OPT_ADD(browser_sort_format, "{%a - }{%t}|{%f} {%l}",
                    apply_browser_sort_format),
OPT_ADD(song_columns_list_format,
                    "(20)[]{a} (6f)[green]{NE} "
                    "(50)[white]{t|f:Title} (20)[cyan]{b} "
                    "(7f)[magenta]{l}",
                    apply_song_columns_list_format),
OPT_ADD(execute_on_song_change, "", apply_execute_on_song_change),
OPT_ADD(execute_on_player_state_change, "",
                    apply_execute_on_player_state_change),
OPT_ADD(playlist_show_mpd_host, "no", apply_playlist_show_mpd_host),
OPT_ADD(playlist_show_remaining_time, "no",
                    apply_playlist_show_remaining_time),
OPT_ADD(playlist_shorten_total_times, "no",
                    apply_playlist_shorten_total_times),
OPT_ADD(playlist_separate_albums, "no",
                    apply_playlist_separate_albums),
OPT_ADD(playlist_display_mode, "columns", apply_playlist_display_mode),
OPT_ADD(browser_display_mode, "classic", apply_browser_display_mode),
OPT_ADD(search_engine_display_mode, "classic",
                    apply_search_engine_display_mode),
OPT_ADD(playlist_editor_display_mode, "classic",
                    apply_playlist_editor_display_mode),
OPT_ADD(discard_colors_if_item_is_selected, "yes",
                    apply_discard_colors_if_item_is_selected),
OPT_ADD(show_duplicate_tags, "yes",
                    apply_show_duplicate_tags),
OPT_ADD(incremental_seeking, "yes",
                    apply_incremental_seeking),
OPT_ADD(seek_time, "1", apply_seek_time),
OPT_ADD(volume_change_step, "2", apply_volume_change_step),
OPT_ADD(autocenter_mode, "no", apply_autocenter_mode),
OPT_ADD(centered_cursor, "no", apply_centered_cursor),
OPT_ADD(progressbar_look, "=>", apply_progressbar_look),
OPT_ADD(default_place_to_search_in, "database",
                    apply_default_place_to_search_in),
OPT_ADD(user_interface, "classic", apply_user_interface),
OPT_ADD(data_fetching_delay, "yes",
                    apply_data_fetching_delay),
OPT_ADD(media_library_hide_album_dates, "no",
                    apply_media_library_hide_album_dates),
OPT_ADD(media_library_primary_tag, "artist",
                    apply_media_library_primary_tag),
OPT_ADD(media_library_albums_split_by_date, "yes",
                    apply_media_library_albums_split_by_date),
OPT_ADD(default_find_mode, "wrapped",
                    apply_default_find_mode),
OPT_ADD(default_tag_editor_pattern, "%n - %t",
                    apply_default_tag_editor_pattern),
OPT_ADD(header_visibility, "yes", apply_header_visibility),
OPT_ADD(statusbar_visibility, "yes", apply_statusbar_visibility),
OPT_ADD(connected_message_on_startup, "yes",
                    apply_connected_message_on_startup),
OPT_ADD(titles_visibility, "yes", apply_titles_visibility),
OPT_ADD(header_text_scrolling, "yes", apply_header_text_scrolling),
OPT_ADD(cyclic_scrolling, "no", apply_cyclic_scrolling),
OPT_ADD(lyrics_fetchers,
                    "azlyrics, genius, letras, musixmatch, tekstowo, "
                    "vagalume, internet",
                    apply_lyrics_fetchers),
OPT_ADD(follow_now_playing_lyrics, "no", apply_follow_now_playing_lyrics),
OPT_ADD(fetch_lyrics_for_current_song_in_background, "no",
                    apply_fetch_lyrics_background),
OPT_ADD(store_lyrics_in_song_dir, "no", apply_store_lyrics_in_song_dir),
OPT_ADD(generate_win32_compatible_filenames, "yes",
                    apply_generate_win32_compatible_filenames),
OPT_ADD(allow_for_physical_item_deletion, "no",
                    apply_allow_for_physical_item_deletion),
OPT_ADD(lastfm_preferred_language, "en", apply_lastfm_preferred_language),
OPT_ADD(space_add_mode, "add_remove", apply_space_add_mode),
OPT_ADD(show_hidden_files_in_local_browser, "no",
                    apply_show_hidden_files_in_local_browser),
OPT_ADD(screen_switcher_mode, "playlist, browser",
                    apply_screen_switcher_mode),
OPT_ADD(startup_screen, "playlist", apply_startup_screen),
OPT_ADD(startup_slave_screen, "", apply_startup_slave_screen),
OPT_ADD(startup_slave_screen_focus, "no",
                    apply_startup_slave_screen_focus),
OPT_ADD(locked_screen_width_part, "50",
                    apply_locked_screen_width_part),
OPT_ADD(ask_for_locked_screen_width_part, "yes",
                    apply_ask_for_locked_screen_width_part),
OPT_ADD(media_library_column_width_ratio_two, "1:1",
                    apply_media_library_column_width_ratio_two),
OPT_ADD(media_library_column_width_ratio_three, "1:1:1",
                    apply_media_library_column_width_ratio_three),
OPT_ADD(playlist_editor_column_width_ratio, "1:2",
                    apply_playlist_editor_column_width_ratio),
OPT_ADD(jump_to_now_playing_song_at_start, "yes",
                    apply_jump_to_now_playing_song_at_start),
OPT_ADD(ask_before_clearing_playlists, "yes",
                    apply_ask_before_clearing_playlists),
OPT_ADD(ask_before_shuffling_playlists, "yes",
                    apply_ask_before_shuffling_playlists),
OPT_ADD(display_volume_level, "yes", apply_display_volume_level),
OPT_ADD(display_bitrate, "no", apply_display_bitrate),
OPT_ADD(display_remaining_time, "no", apply_display_remaining_time),
OPT_ADD(regular_expressions, "extended", apply_regular_expressions),
OPT_ADD(ignore_leading_the, "no", apply_ignore_leading_the),
OPT_ADD(block_search_constraints_change_if_items_found, "yes",
                    apply_block_search_constraints_change),
OPT_ADD(mouse_support, "yes", apply_mouse_support),
OPT_ADD(mouse_list_scroll_whole_page, "no", apply_mouse_list_scroll_whole_page),
OPT_ADD(lines_scrolled, "5", apply_lines_scrolled),
OPT_ADD(empty_tag_marker, "<empty>", apply_empty_tag_marker),
OPT_ADD(tags_separator, " | ", apply_tags_separator),
OPT_ADD(tag_editor_extended_numeration, "no",
                    apply_tag_editor_extended_numeration),
OPT_ADD(media_library_sort_by_mtime, "no",
                    apply_media_library_sort_by_mtime),
OPT_ADD(enable_window_title, "yes", apply_enable_window_title),
OPT_ADD(search_engine_default_search_mode, "1",
                    apply_search_engine_default_search_mode),
OPT_ADD(external_editor, "nano", apply_external_editor),
OPT_ADD(use_console_editor, "yes", apply_use_console_editor),
OPT_ADD(colors_enabled, "yes", apply_colors_enabled),
OPT_ADD(empty_tag_color, "cyan", apply_empty_tag_color),
OPT_ADD(header_window_color, "default", apply_header_window_color),
OPT_ADD(volume_color, "default", apply_volume_color),
OPT_ADD(state_line_color, "default", apply_state_line_color),
OPT_ADD(state_flags_color, "default:b", apply_state_flags_color),
OPT_ADD(main_window_color, "yellow", apply_main_window_color),
OPT_ADD(color1, "white", apply_color1),
OPT_ADD(color2, "green", apply_color2),
OPT_ADD(progressbar_color, "black:b", apply_progressbar_color),
OPT_ADD(progressbar_elapsed_color, "green:b",
                    apply_progressbar_elapsed_color),
OPT_ADD(statusbar_color, "default", apply_statusbar_color),
OPT_ADD(statusbar_time_color, "default:b", apply_statusbar_time_color),
OPT_ADD(player_state_color, "default:b", apply_player_state_color),
OPT_ADD(alternative_ui_separator_color, "black:b",
                    apply_alternative_ui_separator_color),
OPT_ADD(window_border_color, "green", apply_window_border_color),
OPT_ADD(active_window_border, "red", apply_active_window_border),
};
