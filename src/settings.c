...
OPT_ADD("visualizer_autoscale", "no",
...
OPT_ADD("visualizer_spectrum_dft_size", "2",
                    apply_visualizer_spectrum_dft_size),
OPT_ADD("visualizer_spectrum_gain", "10",
                    apply_visualizer_spectrum_gain),
OPT_ADD("visualizer_spectrum_hz_min", "20",
                    apply_visualizer_spectrum_hz_min),
OPT_ADD("visualizer_spectrum_hz_max", "20000",
...
OPT_ADD("playlist_display_mode", "columns",
                    apply_playlist_display_mode),
OPT_ADD("browser_display_mode", "classic",
...
OPT_ADD("statusbar_visibility", "yes",
...
OPT_ADD("header_text_scrolling", "yes",
...
OPT_ADD("lastfm_preferred_language", "en",
...
OPT_ADD("mouse_list_scroll_whole_page", "no",
...
OPT_ADD("enable_window_title", "yes",
...
OPT_ADD("header_window_color", "default",
...
OPT_ADD("state_flags_color", "default:b",
...
OPT_ADD("progressbar_color", "black:b",
