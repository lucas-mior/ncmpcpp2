...
typedef struct NcmActionNameEntry {
    enum NcmActionType type;
    char *name;
} NcmActionNameEntry;

static NcmActionNameEntry action_names[] = {
    { NCM_ACTION_DUMMY, (char *)"dummy" },
    { NCM_ACTION_UPDATE_ENVIRONMENT, (char *)"update_environment" },
    { NCM_ACTION_MOUSE_EVENT, (char *)"mouse_event" },
    { NCM_ACTION_SCROLL_UP, (char *)"scroll_up" },
    { NCM_ACTION_SCROLL_DOWN, (char *)"scroll_down" },
    { NCM_ACTION_SCROLL_UP_ARTIST, (char *)"scroll_up_artist" },
    { NCM_ACTION_SCROLL_UP_ALBUM, (char *)"scroll_up_album" },
    { NCM_ACTION_SCROLL_DOWN_ARTIST, (char *)"scroll_down_artist" },
    { NCM_ACTION_SCROLL_DOWN_ALBUM, (char *)"scroll_down_album" },
    { NCM_ACTION_PAGE_UP, (char *)"page_up" },
    { NCM_ACTION_PAGE_DOWN, (char *)"page_down" },
    { NCM_ACTION_MOVE_HOME, (char *)"move_home" },
    { NCM_ACTION_MOVE_END, (char *)"move_end" },
    { NCM_ACTION_TOGGLE_INTERFACE, (char *)"toggle_interface" },
    { NCM_ACTION_JUMP_TO_PARENT_DIRECTORY, (char *)"jump_to_parent_directory" },
    { NCM_ACTION_RUN_ACTION, (char *)"run_action" },
    { NCM_ACTION_PREVIOUS_COLUMN, (char *)"previous_column" },
    { NCM_ACTION_NEXT_COLUMN, (char *)"next_column" },
    { NCM_ACTION_MASTER_SCREEN, (char *)"master_screen" },
    { NCM_ACTION_SLAVE_SCREEN, (char *)"slave_screen" },
    { NCM_ACTION_VOLUME_UP, (char *)"volume_up" },
    { NCM_ACTION_VOLUME_DOWN, (char *)"volume_down" },
    { NCM_ACTION_ADD_ITEM_TO_PLAYLIST, (char *)"add_item_to_playlist" },
    { NCM_ACTION_PLAY_ITEM, (char *)"play_item" },
    { NCM_ACTION_DELETE_PLAYLIST_ITEMS, (char *)"delete_playlist_items" },
    { NCM_ACTION_DELETE_STORED_PLAYLIST, (char *)"delete_stored_playlist" },
    { NCM_ACTION_DELETE_BROWSER_ITEMS, (char *)"delete_browser_items" },
    { NCM_ACTION_REPLAY_SONG, (char *)"replay_song" },
    { NCM_ACTION_PREVIOUS, (char *)"previous" },
    { NCM_ACTION_NEXT, (char *)"next" },
    { NCM_ACTION_PAUSE, (char *)"pause" },
    { NCM_ACTION_STOP, (char *)"stop" },
    { NCM_ACTION_PLAY, (char *)"play" },
    { NCM_ACTION_EXECUTE_COMMAND, (char *)"execute_command" },
    { NCM_ACTION_SAVE_PLAYLIST, (char *)"save_playlist" },
    { NCM_ACTION_MOVE_SORT_ORDER_UP, (char *)"move_sort_order_up" },
    { NCM_ACTION_MOVE_SORT_ORDER_DOWN, (char *)"move_sort_order_down" },
    { NCM_ACTION_MOVE_SELECTED_ITEMS_UP, (char *)"move_selected_items_up" },
    { NCM_ACTION_MOVE_SELECTED_ITEMS_DOWN, (char *)"move_selected_items_down" },
    { NCM_ACTION_MOVE_SELECTED_ITEMS_TO, (char *)"move_selected_items_to" },
    { NCM_ACTION_ADD, (char *)"add" },
    { NCM_ACTION_LOAD, (char *)"load" },
    { NCM_ACTION_SEEK_FORWARD, (char *)"seek_forward" },
    { NCM_ACTION_SEEK_BACKWARD, (char *)"seek_backward" },
    { NCM_ACTION_TOGGLE_DISPLAY_MODE, (char *)"toggle_display_mode" },
    ...
    { NCM_ACTION_TOGGLE_LYRICS_FETCHER, (char *)"toggle_lyrics_fetcher" },
    ...
    { NCM_ACTION_UPDATE_DATABASE, (char *)"update_database" },
    { NCM_ACTION_JUMP_TO_PLAYING_SONG, (char *)"jump_to_playing_song" },
    { NCM_ACTION_TOGGLE_REPEAT, (char *)"toggle_repeat" },
    { NCM_ACTION_SHUFFLE, (char *)"shuffle" },
    { NCM_ACTION_TOGGLE_RANDOM, (char *)"toggle_random" },
    { NCM_ACTION_START_SEARCHING, (char *)"start_searching" },
    { NCM_ACTION_SAVE_TAG_CHANGES, (char *)"save_tag_changes" },
    { NCM_ACTION_TOGGLE_SINGLE, (char *)"toggle_single" },
    { NCM_ACTION_TOGGLE_CONSUME, (char *)"toggle_consume" },
    { NCM_ACTION_TOGGLE_CROSSFADE, (char *)"toggle_crossfade" },
    { NCM_ACTION_SET_CROSSFADE, (char *)"set_crossfade" },
    { NCM_ACTION_SET_VOLUME, (char *)"set_volume" },
    { NCM_ACTION_ENTER_DIRECTORY, (char *)"enter_directory" },
    { NCM_ACTION_EDIT_SONG, (char *)"edit_song" },
    { NCM_ACTION_EDIT_LIBRARY_TAG, (char *)"edit_library_tag" },
    { NCM_ACTION_EDIT_LIBRARY_ALBUM, (char *)"edit_library_album" },
    { NCM_ACTION_EDIT_DIRECTORY_NAME, (char *)"edit_directory_name" },
    { NCM_ACTION_EDIT_PLAYLIST_NAME, (char *)"edit_playlist_name" },
    { NCM_ACTION_EDIT_LYRICS, (char *)"edit_lyrics" },
    { NCM_ACTION_JUMP_TO_BROWSER, (char *)"jump_to_browser" },
    { NCM_ACTION_JUMP_TO_MEDIA_LIBRARY, (char *)"jump_to_media_library" },
    { NCM_ACTION_JUMP_TO_PLAYLIST_EDITOR, (char *)"jump_to_playlist_editor" },
    { NCM_ACTION_TOGGLE_SCREEN_LOCK, (char *)"toggle_screen_lock" },
    { NCM_ACTION_JUMP_TO_TAG_EDITOR, (char *)"jump_to_tag_editor" },
    { NCM_ACTION_JUMP_TO_POSITION_IN_SONG, (char *)"jump_to_position_in_song" },
    { NCM_ACTION_SELECT_ITEM, (char *)"select_item" },
    { NCM_ACTION_SELECT_RANGE, (char *)"select_range" },
    { NCM_ACTION_REVERSE_SELECTION, (char *)"reverse_selection" },
    { NCM_ACTION_REMOVE_SELECTION, (char *)"remove_selection" },
    { NCM_ACTION_SELECT_ALBUM, (char *)"select_album" },
    { NCM_ACTION_SELECT_FOUND_ITEMS, (char *)"select_found_items" },
    { NCM_ACTION_ADD_SELECTED_ITEMS, (char *)"add_selected_items" },
    { NCM_ACTION_CROP_MAIN_PLAYLIST, (char *)"crop_main_playlist" },
    { NCM_ACTION_CROP_PLAYLIST, (char *)"crop_playlist" },
    { NCM_ACTION_CLEAR_MAIN_PLAYLIST, (char *)"clear_main_playlist" },
    { NCM_ACTION_CLEAR_PLAYLIST, (char *)"clear_playlist" },
    { NCM_ACTION_SORT_PLAYLIST, (char *)"sort_playlist" },
    { NCM_ACTION_REVERSE_PLAYLIST, (char *)"reverse_playlist" },
    { NCM_ACTION_APPLY_FILTER, (char *)"apply_filter" },
    { NCM_ACTION_FIND, (char *)"find" },
    { NCM_ACTION_FIND_ITEM_FORWARD, (char *)"find_item_forward" },
    { NCM_ACTION_FIND_ITEM_BACKWARD, (char *)"find_item_backward" },
    { NCM_ACTION_NEXT_FOUND_ITEM, (char *)"next_found_item" },
    { NCM_ACTION_PREVIOUS_FOUND_ITEM, (char *)"previous_found_item" },
    { NCM_ACTION_TOGGLE_FIND_MODE, (char *)"toggle_find_mode" },
    { NCM_ACTION_TOGGLE_REPLAY_GAIN_MODE, (char *)"toggle_replay_gain_mode" },
    { NCM_ACTION_TOGGLE_ADD_MODE, (char *)"toggle_add_mode" },
    { NCM_ACTION_TOGGLE_MOUSE, (char *)"toggle_mouse" },
    { NCM_ACTION_TOGGLE_BITRATE_VISIBILITY,
      (char *)"toggle_bitrate_visibility" },
    { NCM_ACTION_ADD_RANDOM_ITEMS, (char *)"add_random_items" },
    { NCM_ACTION_TOGGLE_BROWSER_SORT_MODE, (char *)"toggle_browser_sort_mode" },
    { NCM_ACTION_TOGGLE_LIBRARY_TAG_TYPE, (char *)"toggle_library_tag_type" },
    ...
    { NCM_ACTION_REFETCH_LYRICS, (char *)"refetch_lyrics" },
    { NCM_ACTION_SET_SELECTED_ITEMS_PRIORITY,
      (char *)"set_selected_items_priority" },
    { NCM_ACTION_TOGGLE_OUTPUT, (char *)"toggle_output" },
    { NCM_ACTION_TOGGLE_VISUALIZATION_TYPE,
      (char *)"toggle_visualization_type" },
    { NCM_ACTION_SHOW_SONG_INFO, (char *)"show_song_info" },
    { NCM_ACTION_SHOW_ARTIST_INFO, (char *)"show_artist_info" },
    { NCM_ACTION_SHOW_LYRICS, (char *)"show_lyrics" },
    { NCM_ACTION_QUIT, (char *)"quit" },
    { NCM_ACTION_NEXT_SCREEN, (char *)"next_screen" },
    { NCM_ACTION_PREVIOUS_SCREEN, (char *)"previous_screen" },
    { NCM_ACTION_SHOW_HELP, (char *)"show_help" },
    { NCM_ACTION_SHOW_PLAYLIST, (char *)"show_playlist" },
    { NCM_ACTION_SHOW_BROWSER, (char *)"show_browser" },
    { NCM_ACTION_CHANGE_BROWSE_MODE, (char *)"change_browse_mode" },
    { NCM_ACTION_SHOW_SEARCH_ENGINE, (char *)"show_search_engine" },
    { NCM_ACTION_RESET_SEARCH_ENGINE, (char *)"reset_search_engine" },
    { NCM_ACTION_SHOW_MEDIA_LIBRARY, (char *)"show_media_library" },
    { NCM_ACTION_TOGGLE_MEDIA_LIBRARY_COLUMNS_MODE,
      (char *)"toggle_media_library_columns_mode" },
    { NCM_ACTION_SHOW_PLAYLIST_EDITOR, (char *)"show_playlist_editor" },
    { NCM_ACTION_SHOW_TAG_EDITOR, (char *)"show_tag_editor" },
    { NCM_ACTION_SHOW_OUTPUTS, (char *)"show_outputs" },
    { NCM_ACTION_SHOW_VISUALIZER, (char *)"show_visualizer" },
    { NCM_ACTION_SHOW_SERVER_INFO, (char *)"show_server_info" },
};
...
ncm_action_type_name(enum NcmActionType type) {
    for (int32 i = 0; i < NCM_ARRAY_LEN(action_names); i += 1) {
        if (action_names[i].type == type) {
...
ncm_action_type_parse(char *name, int32 name_len,
    ...
    for (int32 i = 0; i < NCM_ARRAY_LEN(action_names); i += 1) {
        ...
        candidate = action_names[i].name;
        candidate_len = ncm_string_len(candidate);
        if (ncm_string_equal(name, name_len, candidate, candidate_len)) {
            *type = action_names[i].type;
            return true;
        }
    }
    return false;
