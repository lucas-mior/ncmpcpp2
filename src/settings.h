...
#define XX_DOUBLE(NAME, DEFAULT_VALUE, MINIMUM, MAXIMUM) \
    double NAME;
#define XX_ENUM(NAME, ENUM_PREFIX_, DEFAULT_VALUE) ENUM_PREFIX_ NAME;
#define XX_MPD_TAG(NAME, DEFAULT_VALUE) enum mpd_tag_type NAME;
#define XX_STARTUP_SCREEN(NAME, DEFAULT_VALUE) NCM_SCREEN_TYPE_ NAME;
#define XX_OPTIONAL_STARTUP_SCREEN( \
    NAME, DEFAULT_VALUE, PRESENT_FIELD, UNSET_VALUE \
) \
    NCM_SCREEN_TYPE_ NAME; \
    bool PRESENT_FIELD;
