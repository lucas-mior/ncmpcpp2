...
bool ncm_mpd_client_set_timeout_ms(NcmMpdClient *client,
                                   int32 timeout_ms,
                                   NcmError *ncm_error);
bool ncm_mpd_client_connect(NcmMpdClient *client, NcmError *ncm_error);
void ncm_mpd_client_disconnect(NcmMpdClient *client);
bool ncm_mpd_client_send_password(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_idle(NcmMpdClient *client, NcmError *ncm_error);
...
bool ncm_mpd_client_play(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_play_pos(NcmMpdClient *client, int32 pos,
                             NcmError *ncm_error);
bool ncm_mpd_client_play_id(NcmMpdClient *client, int32 id,
                            NcmError *ncm_error);
bool ncm_mpd_client_toggle_pause(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_stop(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_next(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_previous(NcmMpdClient *client, NcmError *ncm_error);
...
bool ncm_mpd_client_shuffle(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_shuffle_range(NcmMpdClient *client, int32 start,
                                  int32 end, NcmError *ncm_error);
bool ncm_mpd_client_clear_queue(NcmMpdClient *client, NcmError *ncm_error);
...
bool ncm_mpd_client_add_random_songs(NcmMpdClient *client,
                                     ...
                                     NcmRandom *random,
                                     NcmError *ncm_error);
bool ncm_mpd_client_delete(NcmMpdClient *client, int32 pos, NcmError *ncm_error);
bool ncm_mpd_client_start_command_list(NcmMpdClient *client, NcmError *ncm_error);
bool ncm_mpd_client_commit_command_list(NcmMpdClient *client, NcmError *ncm_error);
...
/* c/ncm_string_format.h */
#define ENUM_NAME NcmStringFormatArgType
#define ENUM_PREFIX_ NCM_STRING_FORMAT_ARG_
#define ENUM_BITFLAGS 0
#define ENUM_FIELDS \
    XX(NCM_STRING_FORMAT_ARG_STRING) \
    XX(NCM_STRING_FORMAT_ARG_I64) \
    XX(NCM_STRING_FORMAT_ARG_U64) \
    XX(NCM_STRING_FORMAT_ARG_F64) \
    XX(NCM_STRING_FORMAT_ARG_CHAR) \
    XX(NCM_STRING_FORMAT_ARG_BOOL)
#include "cbase/xenums.c"
