...
static bool ncm_mpd_item_set_song(NcmMpdItem *item,
...
static bool
ncm_mpd_item_set_song(NcmMpdItem *item, struct mpd_song *source) {
    ...
    if (!ncm_song_from_mpd_song(&replacement.value.song, source)) {
