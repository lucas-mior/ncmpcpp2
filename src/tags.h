...
#define SONG_GETTER_ENUM_FIELD(GETTER, DISP, CHAR) XX(GETTER, DISP)
...
#define ENUM_FIELDS TAG_DEFS(TAG_TYPE_ENUM_FIELD)
#include "cbase/xenums.c"

#define ENUM_NAME SongGetter
#define ENUM_PREFIX_ SONG_GETTER_
#define ENUM_BITFLAGS 0
#define ENUM_FIELDS SONG_GETTER_DEFS(SONG_GETTER_ENUM_FIELD)
#include "cbase/xenums.c"
