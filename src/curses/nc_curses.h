...
void nc_menu_sync_item_len(NcMenu *);
int32 nc_menu_item_len(NcMenu *);
int32 nc_menu_all_item_len(NcMenu *);
int32 nc_menu_filtered_item_len(NcMenu *);
...
int32 nc_menu_selected_len(NcMenu *);
