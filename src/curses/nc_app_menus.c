...
nc_search_row_copy(NcSearchRow *dest, NcSearchRow *source) {
    ...
    ncm_song_copy(&tmp.song, &source->song);
...
nc_editor_sort_row_copy(NcEditorSortRow *dest, NcEditorSortRow *source) {
    ...
    nc_editor_action_row_copy(&tmp.action, &source->action);
...
static const NcMenuItemCallbacks ncm_song_menu_callbacks = {
...
static const NcMenuItemCallbacks nc_media_library_album_menu_callbacks = {
...
static const NcMenuItemCallbacks nc_editor_sort_menu_callbacks = {
    .item_size = SIZEOF(NcEditorSortRow),
    .copy = nc_editor_sort_menu_item_copy,
    .destroy = nc_editor_sort_menu_item_destroy,
};
static const NcMenuItemCallbacks nc_buffer_menu_callbacks = {
...
NC_TYPED_MENU_DEFINE_COMMON(NcSongMenu, nc_song_menu, ncm_song_menu_callbacks)
