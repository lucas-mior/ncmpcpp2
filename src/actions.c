...
XX(dummy, NCM_ACTION_DUMMY)                                                \
XX(update_environment, NCM_ACTION_UPDATE_ENVIRONMENT)                      \
XX(mouse_event, NCM_ACTION_MOUSE_EVENT)                                    \
XX(scroll_up, NCM_ACTION_SCROLL_UP)                                        \
XX(scroll_down, NCM_ACTION_SCROLL_DOWN)                                    \
XX(scroll_up_artist, NCM_ACTION_SCROLL_UP_ARTIST)                          \
XX(scroll_up_album, NCM_ACTION_SCROLL_UP_ALBUM)                            \
XX(scroll_down_artist, NCM_ACTION_SCROLL_DOWN_ARTIST)                      \
XX(scroll_down_album, NCM_ACTION_SCROLL_DOWN_ALBUM)                        \
XX(page_up, NCM_ACTION_PAGE_UP)                                            \
XX(page_down, NCM_ACTION_PAGE_DOWN)                                        \
XX(move_home, NCM_ACTION_MOVE_HOME)                                        \
XX(move_end, NCM_ACTION_MOVE_END)                                          \
XX(toggle_interface, NCM_ACTION_TOGGLE_INTERFACE)                          \
XX(jump_to_parent_directory, NCM_ACTION_JUMP_TO_PARENT_DIRECTORY)          \
XX(run_action, NCM_ACTION_RUN_ACTION)                                      \
XX(previous_column, NCM_ACTION_PREVIOUS_COLUMN)                            \
XX(next_column, NCM_ACTION_NEXT_COLUMN)                                    \
XX(master_screen, NCM_ACTION_MASTER_SCREEN)                                \
XX(slave_screen, NCM_ACTION_SLAVE_SCREEN)                                  \
XX(volume_up, NCM_ACTION_VOLUME_UP)                                        \
XX(volume_down, NCM_ACTION_VOLUME_DOWN)                                    \
XX(add_item_to_playlist, NCM_ACTION_ADD_ITEM_TO_PLAYLIST)                  \
XX(play_item, NCM_ACTION_PLAY_ITEM)                                        \
XX(delete_playlist_items, NCM_ACTION_DELETE_PLAYLIST_ITEMS)                \
XX(delete_stored_playlist, NCM_ACTION_DELETE_STORED_PLAYLIST)              \
XX(delete_browser_items, NCM_ACTION_DELETE_BROWSER_ITEMS)                  \
XX(replay_song, NCM_ACTION_REPLAY_SONG)                                    \
XX(previous, NCM_ACTION_PREVIOUS)                                          \
XX(next, NCM_ACTION_NEXT)                                                  \
XX(pause, NCM_ACTION_PAUSE)                                                \
XX(stop, NCM_ACTION_STOP)                                                  \
XX(play, NCM_ACTION_PLAY)                                                  \
XX(execute_command, NCM_ACTION_EXECUTE_COMMAND)                            \
XX(save_playlist, NCM_ACTION_SAVE_PLAYLIST)                                \
XX(move_sort_order_up, NCM_ACTION_MOVE_SORT_ORDER_UP)                      \
XX(move_sort_order_down, NCM_ACTION_MOVE_SORT_ORDER_DOWN)                  \
XX(move_selected_items_up, NCM_ACTION_MOVE_SELECTED_ITEMS_UP)              \
XX(move_selected_items_down, NCM_ACTION_MOVE_SELECTED_ITEMS_DOWN)          \
XX(move_selected_items_to, NCM_ACTION_MOVE_SELECTED_ITEMS_TO)              \
XX(add, NCM_ACTION_ADD)                                                    \
XX(load, NCM_ACTION_LOAD)                                                  \
XX(seek_forward, NCM_ACTION_SEEK_FORWARD)                                  \
XX(seek_backward, NCM_ACTION_SEEK_BACKWARD)                                \
XX(toggle_display_mode, NCM_ACTION_TOGGLE_DISPLAY_MODE)                    \
XX(toggle_separators_between_albums, NCM_ACTION_TOGGLE_SEPARATORS_BETWEEN_ALBUMS)\
XX(toggle_lyrics_update_on_song_change, NCM_ACTION_TOGGLE_LYRICS_UPDATE_ON_SONG_CHANGE)\
XX(toggle_lyrics_fetcher, NCM_ACTION_TOGGLE_LYRICS_FETCHER)                \
XX(toggle_fetching_lyrics_in_background, NCM_ACTION_TOGGLE_FETCHING_LYRICS_IN_BACKGROUND)\
XX(toggle_playing_song_centering, NCM_ACTION_TOGGLE_PLAYING_SONG_CENTERING)\
XX(update_database, NCM_ACTION_UPDATE_DATABASE)                            \
XX(jump_to_playing_song, NCM_ACTION_JUMP_TO_PLAYING_SONG)                  \
XX(toggle_repeat, NCM_ACTION_TOGGLE_REPEAT)                                \
XX(shuffle, NCM_ACTION_SHUFFLE)                                            \
XX(toggle_random, NCM_ACTION_TOGGLE_RANDOM)                                \
XX(start_searching, NCM_ACTION_START_SEARCHING)                            \
XX(save_tag_changes, NCM_ACTION_SAVE_TAG_CHANGES)                          \
XX(toggle_single, NCM_ACTION_TOGGLE_SINGLE)                                \
XX(toggle_consume, NCM_ACTION_TOGGLE_CONSUME)                              \
XX(toggle_crossfade, NCM_ACTION_TOGGLE_CROSSFADE)                          \
XX(set_crossfade, NCM_ACTION_SET_CROSSFADE)                                \
XX(set_volume, NCM_ACTION_SET_VOLUME)                                      \
XX(enter_directory, NCM_ACTION_ENTER_DIRECTORY)                            \
XX(edit_song, NCM_ACTION_EDIT_SONG)                                        \
XX(edit_library_tag, NCM_ACTION_EDIT_LIBRARY_TAG)                          \
XX(edit_library_album, NCM_ACTION_EDIT_LIBRARY_ALBUM)                      \
XX(edit_directory_name, NCM_ACTION_EDIT_DIRECTORY_NAME)                    \
XX(edit_playlist_name, NCM_ACTION_EDIT_PLAYLIST_NAME)                      \
XX(edit_lyrics, NCM_ACTION_EDIT_LYRICS)                                    \
XX(jump_to_browser, NCM_ACTION_JUMP_TO_BROWSER)                            \
XX(jump_to_media_library, NCM_ACTION_JUMP_TO_MEDIA_LIBRARY)                \
XX(jump_to_playlist_editor, NCM_ACTION_JUMP_TO_PLAYLIST_EDITOR)            \
XX(toggle_screen_lock, NCM_ACTION_TOGGLE_SCREEN_LOCK)                      \
XX(jump_to_tag_editor, NCM_ACTION_JUMP_TO_TAG_EDITOR)                      \
XX(jump_to_position_in_song, NCM_ACTION_JUMP_TO_POSITION_IN_SONG)          \
XX(select_item, NCM_ACTION_SELECT_ITEM)                                    \
XX(select_range, NCM_ACTION_SELECT_RANGE)                                  \
XX(reverse_selection, NCM_ACTION_REVERSE_SELECTION)                        \
XX(remove_selection, NCM_ACTION_REMOVE_SELECTION)                          \
XX(select_album, NCM_ACTION_SELECT_ALBUM)                                  \
XX(select_found_items, NCM_ACTION_SELECT_FOUND_ITEMS)                      \
XX(add_selected_items, NCM_ACTION_ADD_SELECTED_ITEMS)                      \
XX(crop_main_playlist, NCM_ACTION_CROP_MAIN_PLAYLIST)                      \
XX(crop_playlist, NCM_ACTION_CROP_PLAYLIST)                                \
XX(clear_main_playlist, NCM_ACTION_CLEAR_MAIN_PLAYLIST)                    \
XX(clear_playlist, NCM_ACTION_CLEAR_PLAYLIST)                              \
XX(sort_playlist, NCM_ACTION_SORT_PLAYLIST)                                \
XX(reverse_playlist, NCM_ACTION_REVERSE_PLAYLIST)                          \
XX(apply_filter, NCM_ACTION_APPLY_FILTER)                                  \
XX(find, NCM_ACTION_FIND)                                                  \
XX(find_item_forward, NCM_ACTION_FIND_ITEM_FORWARD)                        \
XX(find_item_backward, NCM_ACTION_FIND_ITEM_BACKWARD)                      \
XX(next_found_item, NCM_ACTION_NEXT_FOUND_ITEM)                            \
XX(previous_found_item, NCM_ACTION_PREVIOUS_FOUND_ITEM)                    \
XX(toggle_find_mode, NCM_ACTION_TOGGLE_FIND_MODE)                          \
XX(toggle_replay_gain_mode, NCM_ACTION_TOGGLE_REPLAY_GAIN_MODE)            \
XX(toggle_add_mode, NCM_ACTION_TOGGLE_ADD_MODE)                            \
XX(toggle_mouse, NCM_ACTION_TOGGLE_MOUSE)                                  \
XX(toggle_bitrate_visibility, NCM_ACTION_TOGGLE_BITRATE_VISIBILITY)        \
XX(add_random_items, NCM_ACTION_ADD_RANDOM_ITEMS)                          \
XX(toggle_browser_sort_mode, NCM_ACTION_TOGGLE_BROWSER_SORT_MODE)          \
XX(toggle_library_tag_type, NCM_ACTION_TOGGLE_LIBRARY_TAG_TYPE)            \
XX(toggle_media_library_sort_mode, NCM_ACTION_TOGGLE_MEDIA_LIBRARY_SORT_MODE)\
XX(fetch_lyrics_in_background, NCM_ACTION_FETCH_LYRICS_IN_BACKGROUND)      \
XX(refetch_lyrics, NCM_ACTION_REFETCH_LYRICS)                              \
XX(set_selected_items_priority, NCM_ACTION_SET_SELECTED_ITEMS_PRIORITY)    \
XX(toggle_output, NCM_ACTION_TOGGLE_OUTPUT)                                \
XX(toggle_visualization_type, NCM_ACTION_TOGGLE_VISUALIZATION_TYPE)        \
XX(show_song_info, NCM_ACTION_SHOW_SONG_INFO)                              \
XX(show_artist_info, NCM_ACTION_SHOW_ARTIST_INFO)                          \
XX(show_lyrics, NCM_ACTION_SHOW_LYRICS)                                    \
XX(quit, NCM_ACTION_QUIT)                                                  \
XX(next_screen, NCM_ACTION_NEXT_SCREEN)                                    \
XX(previous_screen, NCM_ACTION_PREVIOUS_SCREEN)                            \
XX(show_help, NCM_ACTION_SHOW_HELP)                                        \
XX(show_playlist, NCM_ACTION_SHOW_PLAYLIST)                                \
XX(show_browser, NCM_ACTION_SHOW_BROWSER)                                  \
XX(change_browse_mode, NCM_ACTION_CHANGE_BROWSE_MODE)                      \
XX(show_search_engine, NCM_ACTION_SHOW_SEARCH_ENGINE)                      \
XX(reset_search_engine, NCM_ACTION_RESET_SEARCH_ENGINE)                    \
XX(show_media_library, NCM_ACTION_SHOW_MEDIA_LIBRARY)                      \
XX(toggle_media_library_columns_mode, NCM_ACTION_TOGGLE_MEDIA_LIBRARY_COLUMNS_MODE)\
XX(show_playlist_editor, NCM_ACTION_SHOW_PLAYLIST_EDITOR)                  \
XX(show_tag_editor, NCM_ACTION_SHOW_TAG_EDITOR)                            \
XX(show_outputs, NCM_ACTION_SHOW_OUTPUTS)                                  \
XX(show_visualizer, NCM_ACTION_SHOW_VISUALIZER)                            \
XX(show_server_info, NCM_ACTION_SHOW_SERVER_INFO)
