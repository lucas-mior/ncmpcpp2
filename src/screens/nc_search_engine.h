...
#define ENUM_NAME NativeSearchEngineSearchMode
#define ENUM_PREFIX_ NATIVE_SEARCH_ENGINE_SEARCH_MODE_
#define ENUM_BITFLAGS 0
#define ENUM_FIELDS \
    X(NATIVE_SEARCH_ENGINE_SEARCH_MODE_LITERAL) \
    X(NATIVE_SEARCH_ENGINE_SEARCH_MODE_REGEX) \
    X(NATIVE_SEARCH_ENGINE_SEARCH_MODE_EXACT)
#include "cbase/xenums.c"

#define ENUM_NAME NativeSearchEnginePromptResult
#define ENUM_PREFIX_ NATIVE_SEARCH_ENGINE_PROMPT_
#define ENUM_BITFLAGS 0
#define ENUM_FIELDS \
    X(NATIVE_SEARCH_ENGINE_PROMPT_ERROR) \
    X(NATIVE_SEARCH_ENGINE_PROMPT_ABORTED) \
    X(NATIVE_SEARCH_ENGINE_PROMPT_ACCEPTED)
#include "cbase/xenums.c"
