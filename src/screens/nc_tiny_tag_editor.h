...
#define ENUM_NAME NativeTinyTagEditorRow
#define ENUM_PREFIX_ NATIVE_TINY_TAG_EDITOR_ROW_
#define ENUM_BITFLAGS 0
#define ENUM_FIELDS \
    X(NATIVE_TINY_TAG_EDITOR_FILE_NAME_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_DIRECTORY_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_UNUSED_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_LENGTH_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_BITRATE_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_SAMPLE_RATE_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_CHANNELS_INFO_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_FIRST_SEPARATOR_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_FIRST_TAG_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_LAST_TAG_ROW, \
      NATIVE_TINY_TAG_EDITOR_FIRST_TAG_ROW + NCM_TAGS_FIELD_LAST - 1) \
    X(NATIVE_TINY_TAG_EDITOR_SECOND_SEPARATOR_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_FILE_NAME_EDIT_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_THIRD_SEPARATOR_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_SAVE_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_CANCEL_ROW) \
    X(NATIVE_TINY_TAG_EDITOR_ROW_COUNT)
