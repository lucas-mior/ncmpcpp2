...
inline void cut(std::string &s, size_t max_width)
{
...
inline std::string shorten(const std::string &s, size_t max_width)
{
...
inline void resize(std::string &s, size_t count, char fill = '\0')
{
...
inline std::string capitalizeFirstLetters(const std::string &s)
{
